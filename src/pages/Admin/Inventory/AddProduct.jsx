  ...
  return (
    <>
        ...
        <div className="mx-auto w-10/12 sm:pl-12 py-24">
            ...
            <form 
                className='border-4 rounded-3xl border-orange px-6 mt-14'
            >
                ...
                <div className='flex flex-row gap-8 font-bold mt-2'>
                    <div className='w-1/3'>
                        <label className='text-center flex flex-col'>Nombre del producto
                            <input className='border-2 border-black py-1 px-2 font-normal ' type="text" />
                        </label>
                    </div>
                    <div className='w-1/3'>
                ...
                <div className='flex flex-row gap-8 font-bold mt-2'>
                    <div className='w-1/3'>
                        <label className='text-center flex flex-col'>Precio de compra
                            <input className='border-2 border-black py-1 px-2 font-light ' type="number" />
                        </label>
                    </div>
                    <div className='w-1/3'>
